...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	if(isset($_POST['s']))
	{
		...
		else if($step == "s2")
		{
			...
			if($s2_bank_code != "" && $s2_account_number != "" && $s2_account_name != "" && $s2_register_channel_id != "" && $s2_phone != "")
			{
	...
	else
	{
		...
		{
			if($firstname != "" AND $bank_id != "" AND $bank_name != "" AND $acc_no != "" AND $tel != "" AND $password != "" AND $refer_id != "" AND $refer_name != "" AND $ip != "")
			{
